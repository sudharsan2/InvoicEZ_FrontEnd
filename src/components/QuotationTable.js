...
const QuotationTable = () => {
  ...
  return (
    <div>
      ...
      {selectedRowData && selectedRowData.status === "quotation" && (
        <QuotationDrawer data={selectedRowData} userId={userId} />
      )}
      {selectedRowData && selectedRowData.status === "To be Acknowledged" && (
        <AckDrawer
