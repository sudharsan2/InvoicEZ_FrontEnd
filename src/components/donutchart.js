...
const DonutChartPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch('http://127.0.0.1:8000/user/dashboard-supplier-morethanonepo');
  ...
  return (
    <div className={styles.root}>
      <div className={styles.chartContainer}>
        <h2 style={{ marginTop: "0.8em", fontWeight: "normal", fontSize: "15px" }}>Invoice Count</h2>
