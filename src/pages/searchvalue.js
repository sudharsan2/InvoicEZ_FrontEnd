...
//     // Ensure that items always results in an array, even if empty
...
//             />
//             {/* Safeguard by passing an empty array if no filteredItems */}
//             <ApproveTable items={filteredItems.length ? filteredItems : []} /> 
//         </div>
//     );
// };
