...
// Grid
const counters = [
    { label: "Total Pages", value: 155, color: "#00bfbf" }, // Cyan
    ...
    <div>
      <div className="Approvebreadcrump">
        <Breadcrumb aria-label="Breadcrumb default example">
          ...
          <BreadcrumbDivider />
          <BreadcrumbItem>
            <BreadcrumbButton href={path}>Document</BreadcrumbButton>
          </BreadcrumbItem>
          <BreadcrumbDivider />
        </Breadcrumb>
      </div>
      <div style={{ display: "flex", justifyContent: "space-between", padding: "1px" }}>
        <div><h3 style={{ fontSize: "1.5em", marginLeft: "5px" }}>Document</h3></div>
