  ...
  return (
    ...
    <Router basename=''>
      <Routes>
        ...
        <Route path="/forgotPassword" element={<CustomLayout><ForgotPassword /></CustomLayout>} />
        <Route path="/resetPassword/:token" element={<CustomLayout><ResetPassword /></CustomLayout>} />
        <Route path="/reset" element={<CustomLayout><ResetPassword /></CustomLayout>} />
        <Route path="/approve" element={<CustomLayout><NavDrawerDefault><UserApprove/></NavDrawerDefault></CustomLayout>}/>
